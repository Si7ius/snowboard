    ...
    var Plugin = {
        ...
        */
        ...
        showSubmenuDropdown: function(item) {
            ...
            // prevent submenu overflowing
            var submenu = mUtil.child(item, '.m-menu__submenu');
            var itemLeft = mUtil.offset(item).left;
            var widthDiff = mUtil.getViewPort().width - mUtil.outerWidth(submenu) - itemLeft - 20;

            if (widthDiff < 0) {
              mUtil.css(submenu, 'left', widthDiff + 'px');
            }
